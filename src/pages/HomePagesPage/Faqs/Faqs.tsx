...
import { Search, MessageCircle, ChevronDown, BookOpen, X, Watch, Laptop, Tablet, Tv, Monitor, Server } from "lucide-react";
    ...
    >
      <style>{`
        ...
        @media (max-width: 768px) {
          /* Compact row layout on mobile to save vertical space */
          .category-pill {
            flex-direction: row;
