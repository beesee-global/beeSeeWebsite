...
import {
  createWebsiteFeaturedProduct,
  updateWebsiteFeaturedProduct,
...
const FeaturedProductForm: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: createWebsiteFeaturedProduct,
    onSuccess: () => {
      setSnackBarType('success');
      setSnackBarMessage('Featured product created successfully');
      setSnackBarOpen(true);
      queryClient.invalidateQueries({ queryKey: ['featured'] });
      navigate('/beesee/website-configuration/featured-product');
    },
    onError: (err: any) => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, formData }: any) => updateWebsiteFeaturedProduct(featuredResponse?.data?.id || id, formData),
    onSuccess: () => {
      setSnackBarType('success');
    ...
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 py-4 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 sm:py-8">
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <Breadcrumb 
            items={[ 
              { label: 'Website Configuration', href: '/beesee/website-configuration/homepage' },
        ...
        <div className="relative mb-6 overflow-hidden rounded-2xl border border-gray-200 bg-white p-4 shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:mb-8 sm:p-6 lg:p-8">
          ...
          <div className="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:gap-3">
              <button 
                onClick={() => navigate('/beesee/website-configuration/featured-product')}
