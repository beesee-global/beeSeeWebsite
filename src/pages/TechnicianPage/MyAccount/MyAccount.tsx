...
import { 
    fetchUserById, 
    updateAccountInfo, 
} from '../../../services/Technician/myAccountServices'
                    ...
                    <div className='md:col-span-2'>
                        ...
                        <div className='space-y-4'>
                            <div className='relative group w-full max-w-2xl'>
                                ...
                                >
                                    <div className={`relative border boder-dashed  dark:border-gray-600 rounded-xl overflow-hidden transition-colors group
                ...
                <div className='bg-white p-6 mt-8 pt-6 border-t dark:border-gray-700'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                        ...
                        <div>
                            ...
                            <span className='ml-2 text-gray-900 dark:text-whte'>
                                { userInformation?.data?.details?.employment_status }
                            </span>
                        </div>
                        ...
                        <div>
                            ...
                            <span className='ml-2 text-gray-900 dark:text-whte'>
                                { userInformation?.data?.details?.position }
                            </span>
                        </div>
                    </div>
                </div>
